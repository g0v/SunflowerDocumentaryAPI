...
var hackpadOptions  = {
    clientID: process.env.HACKPADCLIENTID || 'nsXjf867jj1',
    secret: process.env.HACKPADSECRET || 'W0SQR22JNAkxPKwiBp4YFPwI0vVj8kS7',
    site: '318'
}
...
addTagData = function (content) {
    if (!tagsData.some(function (getTag) { return getTag['name'].toString() == content['name'].toString(); })) {
        tagsData.push({
