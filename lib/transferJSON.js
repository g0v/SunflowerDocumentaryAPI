                ...
                if (rowData.content.$t != '') {
                    ...
                    for (var j = 0; j < eventPlace.length; j++) {
                        ...
                        if (typeof(rowData['gsx$' + eventKeyTmp]) != 'undefined') {
                            ...
                            var placeTmp      = typeof(rowData['gsx$' + eventKey[eventKeyIndex+6].key]) != 'undefined' && eventKey[eventKeyIndex+6].keyName == 'place' ? rowData['gsx$' + eventKey[eventKeyIndex+6].key].$t : eventPlace[j].placeName;
